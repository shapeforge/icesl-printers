-- Universal Geeetech A10 profile
...
--    For the regular A10, this should be set to 1
--    For the regular A10M variant, this should be set to 2
--    For the regular A10T variant, this should be set to 3
